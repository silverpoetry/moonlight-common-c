...
typedef struct _STREAM_CONFIGURATION {
    ...
    // omit cursor pixels from video and send cursor metadata on the control stream.
    bool enableNativeCursor;
...
// or position updates via its control stream extension.
